...
public enum PermissionType {
    ...
    TAG("Tag", new ItemstackFactory(Material.NAME_TAG).setDisplayName("Tag").addLoreLine("&7Players with this permission can change the guild tag.")),
    ...
    FRIENDLYFIRE("Friendlyfire",  new ItemstackFactory(Material.IRON_SWORD).setDisplayName("Slow").addLoreLine("&7Players with this permission can toggle friendlyfire in the guild.")),
    ...
    TAGCOLOR("Tagcolor", new ItemstackFactory(Material.INK_SACK).setDisplayName("Tagcolor").addLoreLine("&7Players with this permission can change the guild's tag color."));
