...
public class playerDamageRegister implements Listener {
    ...
    public void onDeath(PlayerDeathEvent event) {
        ...
        if (Duel.isIngame(event.getEntity())) {
            ...
            event.getEntity().spigot().respawn();
            Bukkit.getPluginManager().callEvent(new PlayerSpawnEvent(event.getEntity()));
        }
    }
    ...
    public void on(EntityDeathEvent event) {
        ...
        try {
            ...
            Bukkit.getServer().getLogger().warning("WARNING! Something went wrong booting the deathEvent at PremiumPvP:listeners.player.playerDamageRegister:44");
        }
